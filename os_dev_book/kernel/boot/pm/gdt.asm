...
gdt_code:                       ; the code segment descriptor
    ...
    ; 2nd flags: (granularity)1 (32-bit defualt)1 (64-bit seg)0 (AVL)0 -> 1100b
...
; when we DS = 0x10 in PM, the CPU knows that we mean it to use the segment 
; described at offset 0x10 (i.e. 16 bytes) in our GDT, which in our case
